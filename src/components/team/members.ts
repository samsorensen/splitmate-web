...
export const members: TeamMember[] = [
  {
    ...
    bio: "Hi, I'm Sam, a Computer Science student at the University of Utah. I'm interested in how software comes together across the full stack, from databases to user interfaces. That led me toward full stack development, with some exposure to DevOps and CI/CD, and a strong focus on building user experiences that feel intuitive and reliable. On the SplitMate capstone, I was team lead. I set up deployment on Vercel, defined our code review workflow and branching conventions, and contributed to both the backend API and the marketing site. My focus was keeping features moving from dev to production without bottlenecks. Outside of school, I ski, see new places, and get outside with a camera, I want to build software that feels simple to use, where the engineering stays invisible and the experience stands out.",
