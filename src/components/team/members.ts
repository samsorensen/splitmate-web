...
export const members: TeamMember[] = [
  ...
  },
  {
    ...
    education: "B.S. Computer Science, 2026",
    bio: "Hey, I'm Elijah, a Computer Science student at the University of Utah. I focus on frontend development, where logic and design meet to shape how users experience a product. I'm especially interested in component architecture, animation, accessibility, and building responsive, polished interfaces. On the SplitMate capstone, I served as Scrum Master while leading much of the iOS frontend in SwiftUI. I organized sprints, ran standups, tracked blockers, and ensured steady progress. I also translated Figma designs into production views, implemented navigation, and worked closely with the backend team to integrate data smoothly. Balancing leadership with development strengthened my communication and decision making around delegation and execution. Outside of coding, I enjoy gaming, films, and exploring restaurants in Salt Lake City. I also experiment with creative coding and follow design trends. I aim to build digital experiences that are intuitive, well crafted, and enjoyable to use.",
